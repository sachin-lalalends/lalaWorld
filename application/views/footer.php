<!-- Mainly scripts -->
    ...
    <script src="/skin/js/plugins/flot/curvedLines.js"></script>

    <!-- Peity -->
    <script src="/skin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/skin/js/demo/peity-demo.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="/skin/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/skin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- Sparkline -->
    <script src="/skin/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/skin/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="/skin/js/plugins/chartJs/Chart.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          ...
          height: 500,
          is3D  : true,
          colors: ['#6fecd1', '#72779c', '#c7c7c7', '#f3b49f'],
        };
